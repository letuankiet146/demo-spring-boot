...
USE test;
INSERT INTO account (account_id, account_user, account_password, account_startdate) VALUES (1,'leminh','$2a$10$xmfbKnZDsCI.f6ASDE29y.IOV1tARo8gKVE3d7w7j8TK2R991J4RO',SYSDATE());
INSERT INTO account (account_id, account_user, account_password, account_startdate) VALUES (2,'lean','$2a$10$xmfbKnZDsCI.f6ASDE29y.IOV1tARo8gKVE3d7w7j8TK2R991J4RO',SYSDATE());
INSERT INTO account (account_id, account_user, account_password, account_startdate) VALUES (3,'myhuyen','$2a$10$xmfbKnZDsCI.f6ASDE29y.IOV1tARo8gKVE3d7w7j8TK2R991J4RO',SYSDATE());
...
INSERT INTO role_linked(role_linked_id,role_id,account_id) VALUES(2,2,2);
INSERT INTO role_linked(role_linked_id,role_id,account_id) VALUES(3,3,3);